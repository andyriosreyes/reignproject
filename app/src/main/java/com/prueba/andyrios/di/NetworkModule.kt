...
import com.prueba.andyrios.data.repository.ArticleRepositoryImp
...
import com.prueba.andyrios.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    fun provideArticlesRepository(
        ...
        return ArticleRepositoryImp(appDatabase,retrofitService)
    }
}